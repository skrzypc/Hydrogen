...
namespace Hydrogen
{
    FGBuilder::FGBuilder(FrameGraph& frameGraph, FGPass& pass) : m_frameGraph(frameGraph), m_pass(pass) {}
    ...
    FGPassNodeAccess FGBuilder::ResolveRead(FGAccess::Read readAccess)
    {
        ...
        case FGAccess::Read::ShaderResource:
            return FGPassNodeAccess{ResourceState{D3D12_BARRIER_SYNC_ALL_SHADING, D3D12_BARRIER_ACCESS_SHADER_RESOURCE,
                                                  D3D12_BARRIER_LAYOUT_SHADER_RESOURCE},
                                    D3D12_RESOURCE_FLAG_NONE, FGUsage::SRV};

        case FGAccess::Read::DepthStencil:
            return FGPassNodeAccess{ResourceState{D3D12_BARRIER_SYNC_DEPTH_STENCIL,
                                                  D3D12_BARRIER_ACCESS_DEPTH_STENCIL_READ,
                                                  D3D12_BARRIER_LAYOUT_DEPTH_STENCIL_READ},
                                    D3D12_RESOURCE_FLAG_ALLOW_DEPTH_STENCIL, FGUsage::DSV};

        case FGAccess::Read::UnorderedAccess:
            return FGPassNodeAccess{ResourceState{D3D12_BARRIER_SYNC_ALL_SHADING, D3D12_BARRIER_ACCESS_UNORDERED_ACCESS,
                                                  D3D12_BARRIER_LAYOUT_UNORDERED_ACCESS},
                                    D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS, FGUsage::UAV};

        case FGAccess::Read::AccelerationStructure:
            return FGPassNodeAccess{ResourceState{D3D12_BARRIER_SYNC_BUILD_RAYTRACING_ACCELERATION_STRUCTURE,
                                                  D3D12_BARRIER_ACCESS_RAYTRACING_ACCELERATION_STRUCTURE_READ,
                                                  D3D12_BARRIER_LAYOUT_UNDEFINED},
                                    D3D12_RESOURCE_FLAG_NONE, FGUsage::AccelerationStructure};

        case FGAccess::Read::CopySrc:
            return FGPassNodeAccess{ResourceState{D3D12_BARRIER_SYNC_COPY, D3D12_BARRIER_ACCESS_COPY_SOURCE,
                                                  D3D12_BARRIER_LAYOUT_COPY_SOURCE},
                                    D3D12_RESOURCE_FLAG_NONE, FGUsage::None};
        default:
            std::unreachable();
            break;
        }
    ...
    FGPassNodeAccess FGBuilder::ResolveWrite(FGAccess::Write writeAccess)
    {
        ...
        case FGAccess::Write::RenderTarget:
            return FGPassNodeAccess{ResourceState{D3D12_BARRIER_SYNC_RENDER_TARGET, D3D12_BARRIER_ACCESS_RENDER_TARGET,
                                                  D3D12_BARRIER_LAYOUT_RENDER_TARGET},
                                    D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET, FGUsage::RTV};
    ...
    FGResourceHandle FGBuilder::AccessInternal(FGResourceHandle handle, FGPassNodeType direction,
                                               FGPassNodeAccess access, FGSubresourceRange range, FGLoadOp loadOp)
    {
        ...
        m_pass.nodes.push_back(FGPassNode{
            .handle = handle,
            .type = direction,
            .access = access,
            .range = range,
