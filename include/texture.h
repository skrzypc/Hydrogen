...
namespace Hydrogen
{
	...
	// Depth formats cannot be used for shader resource views. Casting to the colour format from the
	// same family is allowed as long as the device reports CastingFullyTypedFormatSupported.
	inline DXGI_FORMAT ToShaderResourceFormat(DXGI_FORMAT format)
	{
		switch (format)
		{
