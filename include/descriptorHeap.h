...
namespace Hydrogen
{
    ...
    public:
        ...
        void Initialize(ID3D12Device* pDevice, D3D12_DESCRIPTOR_HEAP_TYPE type, uint32 capacity,
        ...
        ID3D12DescriptorHeap* GetDxHeap() const
        {
            return m_pDxDescriptorHeap.Get();
        }
