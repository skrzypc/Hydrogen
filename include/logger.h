...
#define H2_INFO(logLevel, formatString, ...)                                                                           \
    Hydrogen::Logger::Log(Hydrogen::eLogType::Info, logLevel, std::format(formatString, __VA_ARGS__))

#define H2_WARNING(logLevel, formatString, ...)                                                                        \
    Hydrogen::Logger::Log(Hydrogen::eLogType::Warning, logLevel, std::format(formatString, __VA_ARGS__))

#define H2_ERROR(logLevel, formatString, ...)                                                                          \
    Hydrogen::Logger::Log(Hydrogen::eLogType::Error, logLevel, std::format(formatString, __VA_ARGS__))
#endif